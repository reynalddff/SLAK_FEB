...
exports.getAllAduan = async (req, res) => {
    if (req.user.RoleId === 2) {
        ...
        res.render('admin/aduan_lapor/aduan_lapor', { aduans, notifications, nama_user: req.user.nama_user, success: req.flash('success'), foto_user: req.user.foto_user });
        ...
        res.render('karyawan/aduan_lapor/aduan_lapor', { aduans, notifications, nama_user: req.user.nama_user, success: req.flash('success'), foto_user: req.user.foto_user })
    }
}

exports.createAduan = async (req, res) => {
    // const { judul_aduan, lokasi_aduan, deskripsi_aduan, tujuan_aduan, foto_aduan } = req.body;
...
exports.getContactProfile = async (req, res) => {
    ...
    res.render('karyawan/aduan_lapor/aduan_lapor_konfirmasi_contact', { user, notifications, nama_user: req.user.nama_user, foto_user: req.user.foto_user })
}
...
exports.getAduan = async (req, res) => {
    ...
    if (req.user.RoleId === 2) {
        res.render('admin/aduan_lapor/aduan_lapor_edit_status', { aduan, notifications, nama_user: req.user.nama_user, foto_user: req.user.foto_user })
    } else {
        res.render('operator/aduan_lapor/aduan_lapor_edit_status', { aduan, notifications, nama_user: req.user.nama_user, foto_user: req.user.foto_user, })
    }
}
