...
module.exports = (sequelize, DataTypes) => {
    ...
    "User",
    {
      ...
      isValid: {
        ...
        validate: {
          isIn: {
            args: [
              ["belum divalidasi", "sudah divalidasi", "dibuat oleh admin"],
            ],
            msg:
              "status aduan hanya tersedia 3 pilihan: belum divalidasi, sudah divalidasi atau dibuat oleh admin",
          },
        },
      },
    },
  ...
  User.associate = function (models) {
    ...
    User.hasMany(models.Data_Peminjaman);
